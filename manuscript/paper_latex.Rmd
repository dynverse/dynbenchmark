...
```{r, results='asis' }
add_stable(
  read_rds(figure_file("implementations_table.rds", "03-methods"))[[params$table_format]],
"implementations",
...
```{r echo=FALSE, results="asis"}
add_fig(
  fig_path = figure_file("implementation_qc_overview.tmp.pdf", experiment_id = "03-methods"),
...
```{r}
add_sfig(
  figure_file("edge_flip_comparison.tmp.pdf", experiment_id="02-metrics/4-edge_flip"), 
