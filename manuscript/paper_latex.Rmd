...
add_fig(
  fig_path = figure_file("overview_evaluation_v4.tmp.pdf", experiment_id="manual_figures"),
...
```{r}
add_sfig(
  fig_path = figure_file("overview_evaluation_expanded_v1.tmp.pdf", "manual_figures"),
...
```{r echo=FALSE, results="asis"}
add_fig(
  fig_path = figure_file("implementation_qc_overview.tmp.pdf", experiment_id = "04-method_characterisation"),
...
```{r echo=FALSE, results="asis"}
add_fig(
  fig_path = figure_file("tree.tmp.pdf", experiment_id = "09-user_guidelines"),
...
```{r echo=FALSE, results="asis"}
add_fig(
  fig_path = figure_file("bifurcating_example.tmp.pdf", experiment_id = "14-example_predictions"),
...
```{r}
add_sfig(
  figure_file("overview_wrapping_v1.tmp.pdf", "manual_figures"),
  "overview_wrapping", 
...
```{r}
add_sfig(
  figure_file("aspects_v2.tmp.pdf", experiment_id="manual_figures/metrics"), 
  "score_aspects", 
...
```{r}
add_sfig(
  figure_file("geodesic.tmp.pdf", experiment_id="manual_figures/metrics"), 
  "metric_geodesic", 
...
```{r}
add_sfig(
  figure_file("edge_flip_comparison.tmp.pdf", experiment_id="03-metric_characterisation/4-edge_flip"), 
...
```{r}
add_sfig(
  figure_file("overview_aggregation_v1.tmp.pdf", experiment_id="manual_figures/metrics"), 
