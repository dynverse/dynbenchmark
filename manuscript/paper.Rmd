...
add_sfig(
  ...
  caption_text = "(a) Overall score for all methods and datasets, colored by the source of the datasets. (b)  hown are the distributions of the difference in size between predicted and reference topologies. A positive difference means that the topology predicted by the method is more complex than the one in the reference.",
  width = 12,
  height = 15
)
```
...
# Acknowledgements
We would like to thank the original authors of the methods for their feedback and improvements on the method wrappers.
