...
```{r, results='asis' }
add_stable(
  read_rds(figure_file("implementations_table.rds", "03-method_characterisation"))[[params$table_format]],
"implementations",
...
```{r echo=FALSE, results="asis"}
add_fig(
  fig_path = figure_file("implementation_qc_overview.svg", experiment_id = "03-method_characterisation"),
