...
<!-- Inclusion criterion -->
Methods were excluded from the evaluation based on several criteria: `r glue::glue_collapse(glue::glue("({non_inclusion_reasons$footnote}) {non_inclusion_reasons$long}"), ", ")`. This resulted in the inclusion of  `r n_methods_evaluated` methods in the evaluation.
...
We added several additional TI methods which can be run using just a couple of commands in R. These "off-the-shelf" methods were used to provide baseline performance.←
