...
Given the multilayered complexity of a trajectory model, it is not trivial to compare the similarity of two trajectory models. We therefore sought to use different comparison metrics, each serving a different purpose:
...
Although most metrics described above already assess some aspects directly relevant to the user (eg. whether the method is good at finding the right topology), 

## $`r label_metric("featureimp_cor", "latex")`$: The similarity between features differentially expressed along the trajectory
