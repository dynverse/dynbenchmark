...
All metrics described here were implemented within the _dyneval_ R package ([https://github.com/dynverse/dyneval](https://github.com/dynverse/dyneval)).
...
We generated a panel of toy datasets (using our _dyntoy_ package (https://github.com/dynverse/dyntoy)) with all possible combinations of:
