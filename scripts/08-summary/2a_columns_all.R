...
column_info <- tribble( # tribble_start
  ...
  "scaling_predtime",       "benchmark_overall_time_predcor",               "Pred. correlation",        "funkyrect",  "scaling",        lst(),
  ...
  "scaling_predmem",        "benchmark_overall_mem_predcor",                "Pred. correlation",        "funkyrect",  "scaling",        lst(),
