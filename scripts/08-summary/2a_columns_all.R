...
column_info <- tribble( # tribble_start
  ...
  "scaling_predtime_cells10k",     "scaling_pred_timescore_cells10k_features1k",    "1k features",              "text",    "white6black4",   lst(label = "scaling_pred_timestr_cells10k_features1k", overlay = TRUE, size = 3),
  ...
  "scaling_predtime_cells10k",     "scaling_pred_timescore_cells10k_features100k",  "1k features",              "text",    "white6black4",   lst(label = "scaling_pred_timestr_cells10k_features100k", overlay = TRUE, size = 3),
  "scaling_predtime_features10k",  "scaling_pred_timescore_cells1k_features10k",    "1k cells",                 "rect",    "scaling",        lst(),
  "scaling_predtime_cells10k",     "scaling_pred_timescore_cells1k_features10k",    "1k features",              "text",    "white6black4",   lst(label = "scaling_pred_timestr_cells1k_features10k", overlay = TRUE, size = 3),
