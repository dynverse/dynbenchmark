...
column_info <- tribble( # tribble_start
  ...
  "qc_application",                "qc_app_user_friendly",                         "User friendly",            "circle",                      "qc",
  "qc_application",                "qc_app_developer_friendly",                    "Developer friendly",       "circle",                      "qc",
  "qc_application",                "qc_app_future_proof",                          "Future proof",             "circle",                      "qc",
