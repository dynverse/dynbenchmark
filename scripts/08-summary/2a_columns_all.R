...
column_info <- tribble( # tribble_start
  ...
  "scaling_predtime",       "benchmark_overall_time_predcor",               "Corr. pred. vs. real",     "funkyrect",  "scaling",        lst(),
  ...
  "scaling_predmem",        "benchmark_overall_mem_predcor",                "Corr. pred. vs. real",     "funkyrect",  "scaling",        lst(),
