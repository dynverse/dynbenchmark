...
column_info <- tribble( # tribble_start
  ...
  "scaling_predtime",       "benchmark_overall_time_predcor_str",           "Corr. pred. vs. real",     "text",       NA,               lst(size = 3),
  ...
  "scaling_predmem",        "benchmark_overall_mem_predcor_str",            "Corr. pred. vs. real",     "text",       NA,               lst(size = 3),
