...
column_info <- tribble( # tribble_start
  ...
  "benchmark_metric",       "benchmark_overall_norm_F1_branches",           "Clustering",               "funkyrect",  "benchmark",      lst(),
  ...
  "scaling_predtime",       "scaling_pred_scoretime_cells1m_features100",   "1m cells x 100 features",  "rect",       "scaling",        lst(),
  "scaling_predtime",       "scaling_pred_scoretime_cells1m_features100",   "",                         "text",       "white6black4",   lst(label = "scaling_pred_timestr_cells1m_features100", overlay = TRUE, size = 3),
  "scaling_predtime",       "scaling_pred_scoretime_cells100k_features1k",  "100k x 1k",                "rect",       "scaling",        lst(),
  "scaling_predtime",       "scaling_pred_scoretime_cells100k_features1k",  "",                         "text",       "white6black4",   lst(label = "scaling_pred_timestr_cells100k_features1k", overlay = TRUE, size = 3),
  "scaling_predtime",       "scaling_pred_scoretime_cells10k_features10k",  "10k x 10k",                "rect",       "scaling",        lst(),
  "scaling_predtime",       "scaling_pred_scoretime_cells10k_features10k",  "",                         "text",       "white6black4",   lst(label = "scaling_pred_timestr_cells10k_features10k", overlay = TRUE, size = 3),
  "scaling_predtime",       "scaling_pred_scoretime_cells1k_features100k",  "1k x 100k",                "rect",       "scaling",        lst(),
  "scaling_predtime",       "scaling_pred_scoretime_cells1k_features100k",  "",                         "text",       "white6black4",   lst(label = "scaling_pred_timestr_cells1k_features100k", overlay = TRUE, size = 3),
  "scaling_predtime",       "scaling_pred_scoretime_cells100_features1m",   "100 x 1m",                 "rect",       "scaling",        lst(),
  "scaling_predtime",       "scaling_pred_scoretime_cells100_features1m",   "",                         "text",       "white6black4",   lst(label = "scaling_pred_timestr_cells100_features1m", overlay = TRUE, size = 3),
  "scaling_predmem",        "scaling_pred_scoremem_cells1m_features100",    "1m cells x 100 features",  "rect",       "scaling",        lst(),
  "scaling_predmem",        "scaling_pred_scoremem_cells1m_features100",    "",                         "text",       "white6black4",   lst(label = "scaling_pred_memstr_cells1m_features100", overlay = TRUE, size = 2),
  "scaling_predmem",        "scaling_pred_scoremem_cells100k_features1k",   "100k x 1k",                "rect",       "scaling",        lst(),
  "scaling_predmem",        "scaling_pred_scoremem_cells100k_features1k",   "",                         "text",       "white6black4",   lst(label = "scaling_pred_memstr_cells100k_features1k", overlay = TRUE, size = 2),
  "scaling_predmem",        "scaling_pred_scoremem_cells10k_features10k",   "10k x 10k",                "rect",       "scaling",        lst(),
  "scaling_predmem",        "scaling_pred_scoremem_cells10k_features10k",   "",                         "text",       "white6black4",   lst(label = "scaling_pred_memstr_cells10k_features10k", overlay = TRUE, size = 2),
  "scaling_predmem",        "scaling_pred_scoremem_cells1k_features100k",   "1k x 100k",                "rect",       "scaling",        lst(),
  "scaling_predmem",        "scaling_pred_scoremem_cells1k_features100k",   "",                         "text",       "white6black4",   lst(label = "scaling_pred_memstr_cells1k_features100k", overlay = TRUE, size = 2),
  "scaling_predmem",        "scaling_pred_scoremem_cells100_features1m",    "100 x 1m",                 "rect",       "scaling",        lst(),
  "scaling_predmem",        "scaling_pred_scoremem_cells100_features1m",    "",                         "text",       "white6black4",   lst(label = "scaling_pred_memstr_cells100_features1m", overlay = TRUE, size = 2),
  "stability",              "stability_correlation",                        "Ordering",                 "funkyrect",  "stability",      lst(),
...
column_groups <- tribble( # tribble_start
  ...
  "Benchmark",        "Per metric",                        "benchmark_metric",       "benchmark",
  "Benchmark",        "Per source",                        "benchmark_source",       "benchmark",
  "Benchmark",        "Per trajectory type",               "benchmark_trajtype",     "benchmark",
