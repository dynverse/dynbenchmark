...
method_components <- read_rds(derived_file("method_components.rds", experiment_id = "03-methods"))
component_categories <- read_rds(derived_file("component_categories.rds", experiment_id = "03-methods"))
component_category_colors <- read_rds(derived_file("component_category_colors.rds", experiment_id = "03-methods"))
