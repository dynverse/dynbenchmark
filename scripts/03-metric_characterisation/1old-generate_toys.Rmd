...
```{r}
source("analysis/analyses/03-metric_characterisation/generation.R")
source("analysis/analyses/03-metric_characterisation/perturbation.R")

experiment("03-metric_characterisation/1-generate_toys")
```
