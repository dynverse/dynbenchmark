...
experiment("04-method_testing/site")
...
# read outputs
output <- read_rds(derived_file("output.rds", experiment = "04-method_testing"))
design <- read_rds(derived_file("design.rds", experiment = "04-method_testing"))
