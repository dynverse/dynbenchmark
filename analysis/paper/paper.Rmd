...
```{r}
add_sfig(
figure_file("method_components.svg","4-method_characterisation"), 
"method_components", 
...
We assessed whether the components of an algorithm can be predictive for method performance, using both random forest regression and statistical testing. Methods which include principal curves and clustering (k-means in particular) tend to perform better
...
This is complex though to put into this figure :p. Have a look at 4-method_characteristics/wrapping.svg I think it is the least crucial of all parts of the figure now, so.. But feel free to try it yourself :p
