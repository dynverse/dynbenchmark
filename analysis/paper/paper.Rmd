...
For the next version of the paper, explain the different metrics (and the common trajectory format) with one supplementary figure, like figure evaluation_overview/metric_geodesic.svg