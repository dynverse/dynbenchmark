...
```{r}
add_sfig({
readRDS(figure_file("method_qc_check_plot.rds", experiment_id="method_characteristics"))
}, 
"method_qc_check", 
"Caption", 
10, 
...
```{r}
add_sfig({
readRDS(figure_file("method_components_plot.rds", experiment_id="method_characteristics"))
}, 
"method_components", 
...
pwalk(sfigs, function(ref_id, fig, caption, width, height) {
...
[a]Context and general overview of our evaluation
[b]Outdated