...
n_methods_over_time <- readRDS(figure_file("n_methods_over_time.rds", exp_id="method_characteristics"))
trajectory_components_over_time <- readRDS(figure_file("trajectory_components_over_time.rds", exp_id="method_characteristics"))
