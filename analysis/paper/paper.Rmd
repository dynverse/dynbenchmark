...
`r ref("fig", "results_overview")` HERE ARE THE RESULTS
## Trajectory types
...
Evaluation across trajectory types
...
Top methods tend to contain similar components. Principal curves…
