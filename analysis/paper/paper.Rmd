...
In order to make gold standard trajectories and predicted trajectories directly comparable to one another, we developed a common probabilistic model for representing trajectories from all possible sources 
...
During the execution of a method on a dataset, if the time limit (>6h) or memory limit (32GB) was exceeded, or an error
