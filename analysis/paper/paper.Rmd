...
We created a transparent scoring scheme to check the quality of each method (`r ref("table", "methods")`) and weighed each quality check by the number of times it was found in a list of 
