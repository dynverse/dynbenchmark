...
<!-- Results  -->
Based on the results of our benchmark, we created a set of practical guidelines for method users `r ref("fig", "user_guidelines")`. The main consideration for the choice of a method is based on the user's existing knowledge about what type of trajectory is expected in the data. If the user expects a linear, cyclic or bifurcating trajectory, a specific set of methods .
