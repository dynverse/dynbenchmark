...
axis <-
  tribble(
    ...
    "harm",    "Score",                1.0,   4,       T,           "bar",      T,               "harm_mean_sc_col",                        "harm_mean_sc",

    "line",    "Linear",               1.0,   1,       T,           "circle",   T,               "trajtype_directed_linear_sc_col",         "trajtype_directed_linear_sc",
    ...
    "time",    "Average time",         1.0,   1,       T,           "rect",     F,               "rank_time_method_sc_col",                 "rank_time_method_sc",
    ...
    "qcav",    "Availability",         1.0,   1,       T,           "circle",   F,               "qc_cat_availability_sc_col",              "qc_cat_availability_sc",
...
# WRITE FILES
overview_fig_file <- figure_file("overview_lite.svg")
