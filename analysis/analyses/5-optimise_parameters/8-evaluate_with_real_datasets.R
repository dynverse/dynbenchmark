...
g5 <- ggplot(joined %>% filter(task_group == "real", param_group == "default"), aes(Citations+1, auc_R_nx)) +
  ...
  cowplot::theme_cowplot() +
  scale_x_log10() +
  labs(x = "Citations", y = "auc_R_nx score", title = "auc_R_nx score over # citations")
...
print(cowplot::plot_grid(g1, g4, g2, g5, g3, g6, ncol = 2, align = "hv"))
dev.off()
...
pdf(figure_file("best_param_over_time.pdf"), 12, 8)
