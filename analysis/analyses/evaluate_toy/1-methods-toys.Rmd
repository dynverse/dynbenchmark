...
```{r}
# results <- PRISM::qsub_lapply(names(method_ti_methods), function(method_name) {
...
# }, qsub_environment = list2env(lst(method_ti_methods, tasks, metric_names, method_params)), qsub_config = PRISM::override_qsub_config(memory = "10G", execute_before=c("module load python/x86_64/3.5.1"), wait=F))
```
