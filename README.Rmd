...
From start to finish, the repository is divided into several experiments, each with their own scripts and results. The scripts and results are accompanied by documentation using github READMEs and can be easily explored by going to the appropriate folders:
